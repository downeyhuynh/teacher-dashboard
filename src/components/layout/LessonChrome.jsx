...
export function LessonChrome() {
  ...
  return (
    ...
    >
      <button
        type="button"
        className="lesson-chrome__tab"
        aria-expanded={visible}
        aria-controls="lesson-chrome-panel"
      ...
      {visible ? (
        <div id="lesson-chrome-panel" className="lesson-chrome__body">
          <AutoGrowField
          ...
          <div className="lesson-chrome__center">
            <div
              className="lesson-chrome__switcher"
              role="group"
              aria-label="Subject"
            >
              <button
              ...
              <span className="lesson-chrome__switcher-label">
                {subjectMeta.label}
              </span>
              <button
                type="button"
            ...
            {LESSON_CLASSES.map((classroom) => {
              ...
              return (
                <div key={classroom.id} className="lesson-chrome__class">
                  <span className="lesson-chrome__class-name">
                    {classroom.label}
                  </span>
                  <div
